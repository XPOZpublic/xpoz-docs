...
<Note>
Instagram live methods (`client.instagramLive`) page differently — they use an opaque forward-only cursor with no page numbers or totals. See [TypeScript SDK Live Data](/sdks/typescript/live-data).
</Note>
