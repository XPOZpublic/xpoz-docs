...
<Note>
Instagram live methods (`client.instagram_live`) page differently — they use an opaque forward-only cursor with no page numbers or totals. See [Python SDK Live Data](/sdks/python/live-data).
</Note>
