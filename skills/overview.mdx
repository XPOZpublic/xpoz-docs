...
| Creator Authenticity Score | Vet Instagram creators: view-based engagement rate, bot share of comments, and a 0-100 score | Instagram |
...
| Lead Gen Scan | Find fresh buying-intent posts, qualified and prioritized for human engagement | All |
| GEO Visibility Check | One-shot audit of whether AI engines recommend your brand, and who wins instead | Engines: Claude, ChatGPT, Gemini |
| GEO Reddit | Map the subreddits and threads AI engines cite for your category | Reddit + engines |
| AI Answer Trace | Capture the searches, retrieved pages, and cited sources behind AI answers | Engines: Claude, ChatGPT, Gemini |
...
**Available skill names:** `xpoz-best-practices`, `xpoz-getting-started`, `xpoz-social-tracking`, `social-sentiment-analyzer`, `twitter-data-export`, `influencer-discovery`, `creator-authenticity-score`, `reddit-research`, `competitive-intel`, `security-osint`, `lead-gen-scan`, `geo-visibility-check`, `geo-reddit`, `ai-answer-trace`
...
<CardGroup cols={3}>
  ...
  <Card title="Creator Authenticity Score" icon="user-check" href="/skills/creator-authenticity-score">
    Vet Instagram creators: engagement rate, bot share, and a 0-100 score.
  </Card>
  ...
  <Card title="Lead Gen Scan" icon="bullseye" href="/skills/lead-gen-scan">
    Find fresh buying-intent posts, prioritized for human engagement.
  </Card>
  <Card title="GEO Visibility Check" icon="eye" href="/skills/geo-visibility-check">
    Audit whether AI engines recommend your brand, and who wins instead.
  </Card>
  <Card title="GEO Reddit" icon="map" href="/skills/geo-reddit">
    Map the subreddits and threads AI engines cite for your category.
  </Card>
  <Card title="AI Answer Trace" icon="route" href="/skills/ai-answer-trace">
    Capture the searches and cited sources behind AI answers.
  </Card>
</CardGroup>
