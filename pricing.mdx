...
A search returns up to 300 results for a flat credit price, so credits go a long way: up to 400,000 results on the Free tier, up to 5 million results per month on Pro, and up to 100 million results per month on Max.
