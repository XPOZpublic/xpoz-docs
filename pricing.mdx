...
| Max        | \$200/mo (\$160/mo billed annually) | 120,000/month    | \$0.40 per 1,000 |
...
A search returns up to 300 results for a flat credit price, so credits go a long way: over 1 million results per month on Pro, and up to 18 million results per month on Max.
