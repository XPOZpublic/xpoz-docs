...
`getInstagramUsersByKeywords` also returns aggregation fields: `aggRelevance`, `relevantPostsCount`, `relevantPostsLikesSum`, `relevantPostsCommentsSum`, `relevantPostsResharesSum`, `relevantPostsMediaRepostsSum`, `relevantPostsSavesSum`, `relevantPostsVideoPlaysSum`.
...
| **Engagement** | `likeCount`, `commentCount`, `reshareCount`, `mediaRepostCount`, `saveCount`, `videoPlayCount` |
